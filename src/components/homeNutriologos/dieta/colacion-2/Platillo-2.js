        ...
        return(
            <div>
                 <div className={this.props.mostrar}>
                         ...
                         <FormControl type="text" placeholder="Escribe el nombre del equivalente" onChange={this.props.busqueda}/>
...
export default Platillo2Colacion2