...
class HomePage extends Component {
  ...
  render() {
    ...
    if(this.state.user){
      const  {nombre} = this.state.user;
      return(
            <Grid>
  <Row className="show-grid">
    <Col xs={12} md={2}>
     <ul className="left-menu">
        <li className="left-menu-item">  <Globe  className="ic" size={20} /> Comunidad</li>
        <li className="left-menu-item">  <Users  className="ic" size={20} /> Consultorio</li>
